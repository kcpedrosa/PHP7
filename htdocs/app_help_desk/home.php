<?php
  ...
  print_r($_SESSION);
  //check valida_login, if you logged as john your printed id will be 1
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="navbar-item">
        <a class="btn btn-outline-info my-2 my-sm-0 " href="">Logged as: <?= $_SESSION['email']; ?></a>
    </li>
    <li class="navbar-item">
